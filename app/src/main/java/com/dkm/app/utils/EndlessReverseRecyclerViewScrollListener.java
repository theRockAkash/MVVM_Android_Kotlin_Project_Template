...
public abstract class EndlessReverseRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        ...
        int lastVisibleItemPosition = totalItemCount - 1;
        if (mLayoutManager instanceof StaggeredGridLayoutManager) {
            ...
            lastVisibleItemPosition = ((GridLayoutManager) mLayoutManager).findFirstVisibleItemPosition();
        } else if (mLayoutManager instanceof LinearLayoutManager) {
            lastVisibleItemPosition = ((LinearLayoutManager) mLayoutManager).findFirstVisibleItemPosition();
        }
        onScroll(view, dx, dy, lastVisibleItemPosition);
    ...
    public abstract void onScroll(RecyclerView view, int dx, int dy, int position);
